...
import com.lumou.reggie.service.UserService;
import com.lumou.reggie.utils.ValidateCodeUtils;
...
public class UserController {
    ...
    public R<String> sendMsg(HttpSession session, @RequestBody User user){
        //获取邮箱号
        //相当于发送短信定义的String to
        String email = user.getPhone();//获取邮箱号
        String subject = "瑞吉外卖";
    ...
    public R<User> login(HttpSession session,@RequestBody Map map){
        ...
        if (sessionCode != null && sessionCode.equals(code)) {
            ...
            session.setAttribute("user", user.getId());//保存sessin的登陆信息session.setAttribute("sessionName",Object);
